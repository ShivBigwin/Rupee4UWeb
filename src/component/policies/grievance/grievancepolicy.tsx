  ...
  const sections: any = {
    introduction: {
      ...
      content: `
        ...
        <p class="mt-4">Rupee4U Private Limited (“the Company” or “Rupee4U”) is a Non-Banking Financial Company (NBFC) registered with the Reserve Bank of India (“RBI”). As a responsible financial institution committed to ethical business practices and regulatory compliance, Rupee4U places the highest priority on providing transparent, fair, and customer-centric services.</p><br/>
    ...
    scope: {
      ...
      content: `
         ...
         <p class="text-sm  text-black ">It applies to all offices, branches, business correspondents, agents, and digital platforms of Rupee4U, irrespective of geographic location.</p>
         </div>
